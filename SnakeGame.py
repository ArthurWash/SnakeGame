...
pygame.display.set_caption('Snake Game by Washdude')
...
score_font = pygame.font.SysFont("San Francisco", 35)

def Your_score(score):
    value = score_font.render("Score: " + str(score), True, neon_green)
    dis.blit(value, [0, 0])
